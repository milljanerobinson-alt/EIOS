/*
# EWO-042: Fix atd_connect_inspection_log NOT NULL columns
*/
...
BEGIN
    ...
    'governance', jsonb_build_object(
      ...
      'approval_record', CASE
        WHEN v_approval IS NOT NULL THEN jsonb_build_object(
          ...
          'approved_by', v_approval.product_owner,
  ...
  INSERT INTO atd_connect_inspection_log (
    request_id, timestamp, requesting_persona, operation, inspected_capability,
    outcome, request_source, original_request
  ) VALUES (
    v_audit_ref, now(), 'system', 'inspectExecutionPackage',
