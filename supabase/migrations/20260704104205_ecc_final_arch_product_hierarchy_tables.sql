...
-- ──────────────────────────────────────────────────────────────────────────────
-- EOC Final Architecture Refactor: Product Hierarchy
-- Creates: ecc_product, ecc_roadmap_items, ecc_milestones, ecc_phases
-- Extends: ecc_release_candidates, ecc_releases with phase_id / milestone_id
-- ──────────────────────────────────────────────────────────────────────────────
...
-- 4. Phases (proper entity, separate from RC phase_name labels)
